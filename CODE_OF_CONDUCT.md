...
This Code of Conduct applies within all community spaces associated with this project — GitHub Issues, Pull Requests, Discussions, and any related communication channels — and also when an individual is officially representing the community in public spaces.
...
Reports of unacceptable behavior may be sent by:
- Opening a private report via the GitHub Security Advisory process, or
- Contacting the maintainers directly through GitHub (via a private Discussion or by mentioning them in a locked Issue reviewed by maintainers only)
